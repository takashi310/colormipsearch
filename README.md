...
```
java  -Xmx120G -Xms120G -jar target/colormipsearch-2.1-jar-with-dependencies.jar \
    searchLocalFiles \
...
```
java -Xmx480G -Xms480G -jar target/colormipsearch-2.1-jar-with-dependencies.jar \
    searchLocalFiles \
...
```
java -jar target/colormipsearch-2.1-jar-with-dependencies.jar \
    gradientScore \
...
```bash
java \
    -jar target/colormipsearch-2.1-jar-with-dependencies.jar \
