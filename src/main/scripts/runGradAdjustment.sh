...
DEFAULT_MEM_RESOURCE=180
DEFAULT_TOP_RESULTS=100
DEFAULT_LIB_PARTITION_SIZE=100
SAMPLES_PER_LINE=0;

MEM_RESOURCE=${MEM_RESOURCE:-$DEFAULT_MEM_RESOURCE}
TOP_RESULTS=${TOP_RESULTS:-$DEFAULT_TOP_RESULTS}
LIB_PARTITION_SIZE=${LIB_PARTITION_SIZE:-$DEFAULT_LIB_PARTITION_SIZE}
