...
class EMScoreAdjuster {
    ...
    void process(MIPWithPixels libraryMIP, MIPWithPixels pattern, MIPWithPixels patternGradient) {
    ...
    long calculateScoreAdjustment(MIPWithPixels libraryMIP, MIPWithPixels pattern, MIPWithPixels patternGradient, Operations.ImageTransformation patternTransformation) {
