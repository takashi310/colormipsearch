...
public interface NeuronMatchesDao<M extends AbstractNeuronMetadata,
    ...
    long countNeuronMatches(NeuronSelector maskSelector, NeuronSelector targetSelector, Class<R> matchType);
    PagedResult<R> findNeuronMatches(NeuronSelector maskSelector,
